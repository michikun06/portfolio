...
if (process.env.GATSBY_EXPERIMENTAL_PLUGIN_OPTION_VALIDATION) {
  ...
  exports.pluginOptionsSchema = function ({
    ...
    return Joi.object({
      ...
      postCssPlugins: Joi.array().items(Joi.object({}).unknown(true)).description(`An array of postCss plugins`),
      ...
      functions: Joi.object().pattern(MATH_ALL_KEYS, Joi.function().maxArity(2)).description(`functions is an Object that holds a collection of custom functions that may be invoked by the sass files being compiled.`),
      ...
      outputStyle: Joi.string().valid(`nested`, `expanded`, `compact`, `compressed`).default(`nested`).description(`Determines the output format of the final CSS style.`),
